...
app.config['MYSQL_HOST'] = os.environ.get('DO_DB_HOST')
app.config['MYSQL_PORT'] = int(os.environ.get('DO_DB_PORT'))
app.config['MYSQL_USER'] = os.environ.get('DO_DB_USER')
app.config['MYSQL_PASSWORD'] = os.environ.get('DO_DB_DBNAME')
app.config['MYSQL_DB'] = os.environ.get('DO_DB_PORT')
